...
const DepartmentValidationTestComponent=()=>{
    ...
    return(
        <Fragment>
            <div className='form-group'>
                <label>DeptNo</label>
                <input type="text" value={department.deptno} name="deptNo" onChange={(evt)=>setDepartment({...department, deptno:parseInt(evt.target.value)})} className="form-control"/>
            </div>
            <div className='form-group'>
...
export default DepartmentValidationTestComponent;